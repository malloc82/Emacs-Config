...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "matlab" '("gud-matlab-debug-active" "matlab-" "ml-fl-anchor-limit")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "matlab-scan" '("matlab-" "mlf-")))

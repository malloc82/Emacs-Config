...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box (:line-width 1 :color nil :style released-button) :bold t :foreground "black" :background "grey70"))))

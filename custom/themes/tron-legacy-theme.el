...
(custom-theme-set-faces
 `tron-legacy
 `(default ((t (:background "#000000" :foreground  "#B0CCDC"))))
 ...
 `(which-func ((t (:foreground "#4BB5BE"))))
 ...
 `(font-lock-doc-face ((t (:foreground "#828D9C" :italic nil))))
 `(font-lock-comment-face ((t (:foreground "#6A8397"
                               :background nil
                               :italic nil))))
 `(font-lock-number-face ((t (:foreground "chocolate2"))))
